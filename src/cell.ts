...
export class NRXCell {
  ...
  /**
   * Sets the background color to a new color generated by lerping the current background color, by the given
   * proportion, with the new values.
   * @param  {number} r The red component of the new color
   * @param  {number} g The green component of the new color
   * @param  {number} b The blue component of the new color
  ...
  public lerpBgc(r: number, g: number, b: number, proportion: number): void {
    ...
    this._bgc = Lerp.lerpColor(this._bgc, new Color(r, g, b), proportion);
  }

  /**
   * Sets the foreground (i.e. character) color to a new color generated by lerping the current background color, by
   * the given proportion, with the new values.
   * @param  {number} r The red component of the new color
   * @param  {number} g The green component of the new color
   * @param  {number} b The blue component of the new color
  ...
  public lerpFgc(r: number, g: number, b: number, proportion: number): void {
    ...
    this._fgc = Lerp.lerpColor(this._fgc, new Color(r, g, b), proportion);
  }
